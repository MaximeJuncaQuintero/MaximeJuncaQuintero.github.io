...
export default function AmazonKPIPage() {
  ...
  return (
    <ProjectDetail
      ...
      method={isFr
        ? `L'exécution du projet s'est articulée en plusieurs étapes clés :
...
Solutions alternatives : face aux limites d'extraction directe de certaines métriques ATS depuis PerfectMile, exploration d'approches complémentaires via PerfectMetrics et Metric Audit.`
        : `The project's execution involved several key steps:
